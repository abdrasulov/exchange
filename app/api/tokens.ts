import { BlockchainType, Token, TokenTypeEip20, TokenTypeNative } from '@/app/api/types'
...
export function getNativeToken(addressFormat: string): Token | null {
  if (addressFormat == 'ADDRESS_FORMAT_ETHEREUM') {
    return new Token('ETH', 'Ethereum', 18, BlockchainType.Ethereum, new TokenTypeNative())
  }
