  ...
  return (
    <section className="group relative overflow-hidden rounded-2xl border border-neutral-200 bg-white/60 shadow-sm backdrop-blur-xl transition-all hover:shadow-md dark:border-neutral-800 dark:bg-neutral-900/40">
      ...
      <div className="p-6">
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">Your identity has not been verified yet.</p>
  ...
  return (
    <section className="group relative overflow-hidden rounded-2xl border border-neutral-200 bg-white/60 shadow-sm backdrop-blur-xl transition-all hover:shadow-md dark:border-neutral-800 dark:bg-neutral-900/40">
      ...
      <div className="p-6">
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">Checking your verification status…</p>
      </div>
    </section>
  )
}
